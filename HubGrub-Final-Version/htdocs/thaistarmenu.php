...
$sql = "SELECT dishCategory FROM dishmodel WHERE restaurantID=3 GROUP BY dishCategory";
...
<body>
    ...
    { 
        ...
        {
            $sql2 = "SELECT dishID, dishName, dishPrice FROM dishmodel WHERE restaurantID =3 AND dishCategory='" . $resultArray[$i] . "'";
